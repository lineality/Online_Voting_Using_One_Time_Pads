...
https://www.datacamp.com/courses/analyzing-election-and-polling-data-in-r?irclickid=TtWxHF0I7xyNUMqzKwUmBUEhUkD3QI3tIzmPW80&irgwc=1&utm_medium=a# Online_Voting_Using_One_Time_Pads
#### Online Voting Using One Time Pads 
#### & Notes on General Election Software
...
Step 9: (Mark Ballot with Vote Choices) The voter, off-line(using pen and paper), fills out the ballot (selecting their vote choices). (Details here may be important in some way: filling in a circle, selecting an option number, multi-factor, non-over-under-voting checks, etc.)
...
affiliate&utm_source=impact&utm_campaign=2556128 
